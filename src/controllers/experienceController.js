...
exports.updateExperience = async (req, res) => {
  ...
  // Vérifier si le champ 'job_title' est fourni et est de type chaîne de caractères non vide
  if (req.body.job_title !== undefined && req.body.job_title.trim() !== '') {
    if (req.body.job_title.trim() == "delete") {
      // Utiliser l'opérateur $unset de Mongoose pour supprimer le champ job_title
      updatedFields.$unset = { job_title: "" };
    } else {
